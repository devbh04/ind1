  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="p-4">
        ...
        {/* Action Button */}
        <button onClick={()=>{router.push('/mentorship/mentor-id')}} className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-md transition-colors">
