  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        ...
        <meta
          name="description"
          content="Browse and connect with expert mentors"
        />
      </Head>
          ...
          <div className="flex flex-col gap-3 w-full lg:w-3/5">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {(currentUser?.userType === "mentor" ||
                ...
                <Link
                  href="/mentorship/mentor-registeration"
                  className="bg-amber-600 flex items-center h-10 sm:text-xl text-white border border-white hover:bg-white hover:border-amber-600 hover:text-amber-600 rounded-full p-4 sm:p-6 transition-all duration-100"
                >
                  + Become Mentor
                </Link>
              )}
